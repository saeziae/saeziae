...
- [吳語輸入法](https://nguphing.saeziae.net/)
- [MtF Wiki](https://MtF.wiki)

---

- Pronouns: She/her
- 💬 中文(ZH) English(EN) Español(ES), [Wu language](https://en.wikipedia.org/wiki/Wu_Chinese) native speaker. [Wu language input method](https://github.com/saeziae/rime_nguphing) is now in active development.
- <img height="18" alt="🏳️‍⚧️" src="https://saeziae.github.io/moji/moji/trans.svg"/> Proudly being trans. Maintainer of [MtF-Wiki](https://github.com/mtf-wiki/MtF-Wiki).
- 👩‍🎓 Majoring in language, not computer science. Interested in linguistics, NLP, and other things.
- ⌨️  <img height="18" src="https://saeziae.github.io/moji/moji/python.svg"/>Python  <del><img height="18" src="https://saeziae.github.io/moji/moji/php.svg"/>PHP is the best language in the world</del>
- Wanting an ARM PC.
...
- BTC `13YmgQwSh2BYczyxQPuGxuA19sMm2HomZs`
