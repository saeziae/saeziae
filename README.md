...
Rhythm game player!!! Everyone should love [Akiyama Mizuki](https://projectsekai.fandom.com/wiki/Akiyama_Mizuki) !!!

Web, cybersecurity, machine learning, NLP.

Diachronic linguistics, historical Chinese phonology.

📷 Photographer ✈️ Traveller | target: around the world!

👩🏼‍💻  C Python Go. Hope to understand Rust.

Using ARM desktop and server, playing with RISC-V. Wanting an ARM laptop.

Arch Linux user, now on i3wm.
...
- <a href='https://ko-fi.com/saeziae' target='_blank'><img height='36' style='border:0px;height:36px;' src='https://storage.ko-fi.com/cdn/kofi3.png?v=3' border='0' alt='Buy Me a Coffee at ko-fi.com' /></a>
